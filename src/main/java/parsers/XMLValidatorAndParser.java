...
public class XMLValidatorAndParser {
    ...
    public static void parseXML(String xmlFilePath) {
        try {
            ...
            NodeList employeeNodeList = doc.getElementsByTagName("supermarket");
            for (int temp = 0; temp < employeeNodeList.getLength(); temp++) {
                Node employeeNode = employeeNodeList.item(temp);
    ...
    public static void main(String[] args) {
        String xmlFilePath = "src/main/resources/xml/supermarketExample.xml";
